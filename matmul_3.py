...
class BarrierArray:
    ...
    def expect_tx_bytes(self, index: int, tx_count: int):
...
class GemmKernel:
    def __init__(self):
        ...
        self.num_warpgroups = self.BM // 64
    ...
    def __call__(self, A, B, C, stream):
        ...
        tiled_mma = sm90_utils.make_trivial_tiled_mma(
            ...
            (self.num_warpgroups, 1, 1), # atom layout mnk, number of warpgroups per dimension
        ...
        num_threads = 128 * self.num_warpgroups
        ...
        while work_tile.is_valid_tile:
            ...
            for tile_k in cutlass.range_dynamic(num_tiles_k):
                ...
                if warp_idx_in_warpgroup == 0:
                    ...
                    empty_array.wait(producer_state.index, producer_state.phase)
                    ...
                    full_array.expect_tx_bytes(producer_state.index, tma_copy_bytes)
                ...
                full_array.wait(consumer_state.index, consumer_state.phase)
